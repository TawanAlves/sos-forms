...
export function FootballBootStep({
  data,
  onDataChange,
  onNext,
  onPrev,
  ...
  const validateForm = (): boolean => {
    ...
    if (!data.braSize) {
      newErrors.braSize = "Selecione a numeração BRA teste";
    }

    if (!data.measurements?.trim()) {
      newErrors.measurements = "Informe as medidas da palmilha";
    } else {
      // [ALTERAÇÃO] Validação detalhada das medidas da palmilha
  ...
  return (
    <StepWrapper
      title="Especificações da Palmilha - Chuteira"
      subtitle="Configure as especificações para a palmilha da chuteira"
    >
          ...
          <div className="flex items-center space-x-2">
            <div className="flex-1">
              <input
                ...
                onChange={(e) => {
                  // [ALTERAÇÃO] Validação para aceitar apenas 3 números no comprimento
            ...
            <div className="flex-1">
              <input
                ...
                onChange={(e) => {
                  // [ALTERAÇÃO] Validação para aceitar apenas 3 números na largura
                  const value = e.target.value.replace(/[^0-9]/g, "").slice(0, 3);
                  const parts = data.measurements?.split("x") || ["", "", ""];
                  parts[1] = value;
                  handleInputChange("measurements", parts.join("x"));
            ...
            <div className="flex-1">
              <input
                ...
                onChange={(e) => {
                  // [ALTERAÇÃO] Validação para aceitar apenas 2 números na espessura
