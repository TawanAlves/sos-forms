...
export function FlipflopsStep({
  ...
  const validateForm = (): boolean => {
    ...
    if (!data.quantity) {
      newErrors.quantity = "Selecione a quantidade de palmilhas - Sandália";
    }
  ...
  return (
    <StepWrapper
      title="Especificações da Palmilha - Chinelo"
    ...
    >
      <div className="space-y-8">
        ...
        <div>
          ...
          >
            Quantidade de Chinelos (par) <span className="text-red-500">*</span>
          </label>
          <select
            id="quantity"
            value={data.quantity || ""}
        ...
        <div>
          <label className="block text-sm font-bold text-gray-700 mb-2">
            Medida do Chinelo em mm <span className="text-red-500">*</span>
          </label>
          <p className="text-sm text-gray-600 mb-2">
            Comprimento X largura na região dos metatarsos
          </p>
          {/* X espessura */}
          ...
          <div className="flex items-center space-x-2">
            <div className="flex-1">
              <input
                ...
                onChange={(e) => {
                  // [ALTERAÇÃO] Validação para aceitar apenas 3 números no comprimento (chinelo)
            ...
            <div className="flex-1">
              <input
                ...
                onChange={(e) => {
                  // [ALTERAÇÃO] Validação para aceitar apenas 3 números na largura (chinelo)
                  const value = e.target.value.replace(/[^0-9]/g, "").slice(0, 3);
                  const parts = data.measurements?.split("x") || ["", ""];
                  parts[1] = value;
                  handleInputChange("measurements", parts.join("x"));
