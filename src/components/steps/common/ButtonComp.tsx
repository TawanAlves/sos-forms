  ...
  if (isBack) {
    ...
    return (
      ...
      <button
        onClick={onClick}
        disabled={disabled}
        className="px-6 py-2 border border-b-gray-400 text-gray-600 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors"
      >
        <span>Escolher Outro Elemento</span>
      </button>
      // </div>
    );
  }
