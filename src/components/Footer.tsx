          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <p className="text-blue-100 mb-4 max-w-md">
                ...
                Oferecemos soluções inovadoras para o cuidado dos seus pés com
              ...
              <div className="space-y-2 text-blue-100">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-sm">
                    <Link
                      href="tel:+5511978702088"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-sm hover:text-white transition-colors"
                      aria-label="WhatsApp"
                    >(11) 97870‑2088</Link></span>
                </div>
                <div className="flex items-center">
                  <svg
                    className="w-4 h-4 mr-2"
                  ...
                  <a
                    href="mailto:licenciados@sospalmilha.com.br?subject=Contato%20SOS%20Palmilhas&body=Olá,%20gostaria%20de%20entrar%20em%20contato"
                    className="text-sm hover:text-white transition-colors"
                  >
                  licenciados@sospalmilha.com.br  
                  </a>
                </div>
              </div>
            </div>
